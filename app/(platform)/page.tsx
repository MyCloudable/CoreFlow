...
const FEATURES = [
  ...
  { title: "Service tickets & field visits", body: "A real ticketing queue with priorities and assignments — and a mobile portal your technicians work from on site." },
  ...
  { title: "Simple seat pricing", body: "$99/mo base + $5/mo per team member, 14-day free trial. Unlimited clients, always free for them." },
];
      ...
      <main className="mx-auto max-w-5xl px-6">
        <section className="py-20 text-center">
          <h1 className="mx-auto max-w-3xl text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            The white-label client portal for agencies, consultants & field service teams
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-lg text-gray-600">
            Give every client a branded home for deliverables, project progress, service tickets,
            scheduled visits, orders, and reports — and become operational infrastructure they
            can&apos;t leave.
          </p>
          <p className="mt-8 inline-block rounded-full bg-orange-50 px-5 py-2 text-sm font-semibold text-orange-700">
            $99/mo base · $5/mo per employee · 14-day free trial · unlimited free client logins
          </p>
        </section>
